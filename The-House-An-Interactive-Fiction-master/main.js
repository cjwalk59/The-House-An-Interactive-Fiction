...
let gun0 = new Item("magnum", "empty, COMBINE with bullet.")
let gun1 = new Item("magnum", "loaded with a bullet.")
let gun2 = new Item("magnum", "fully loaded with slugs.")
...
let metal_shard1 = new Item("metal shard", "is from a small metal object, 'Emergency fi' is engraved on it.")
let metal_shard2 = new Item("glued metal shard", "glued with heatproof glue.")
...
let car = new Item("crashed police cruiser", "completely totaled and will never work again, but how is it molten?")
let chalk1 = new Item("white chalk", "hot to the touch.")
let chalk2 = new Item("red chalk", "really hot to the touch.")
let orphan = new Item("orphan", "only a newborn and it's already abused regularly just because it's disabled, it's so LOUD and riddled with singed holes.")
// Put them in their spots
start.addItem(gun);
start.addItem(bullet);
start.addItem(note);
start.addItem(hallway);
hallway.addItem(start);
hallway.addItem(vase);
hallway.addItem(boiler_room);
hallway.addItem(basement);
hallway.addItem(closet);
basement.addItem(hallway);
basement.addItem(swat_vest1);
basement.addItem(battering_ram);
basement.addItem(warning);
basement.addItem(damp_room);
damp_room.addItem(basement);
damp_room.addItem(cement_mix);
damp_room.addItem(car_jack);
boiler_room.addItem(hallway);
...
bodybag.addItem(boiler_room);
bodybag.addItem(armor_padding);
bodybag.addItem(ladder);
boiler.addItem(boiler_room);
boiler.addItem(wrench);
boiler.addItem(metal_shard1);
garage.addItem(boiler_room);
...
driveway.addItem(garage);
driveway.addItem(chalk1);
driveway.addItem(chalk2);
driveway.addItem(park);
park.addItem(driveway);
park.addItem(car);
attic.addItem(garage)
attic.addItem(oil_canister);
attic.addItem(small_device);
closet.addItem(hallway);
closet.addItem(lockbox_key);
closet.addItem(coat1);
closet.addItem(orphan);
...
let check = function(action, player, object) {
  if (action == 'check'){
    ...
    addLine("Item List: " + l)
    if (h == 10 && p == true) {
      addLine("Something is... off.")
    } else if (h == 9 && p == true) {
     addLine("Your stomach is hurting.")
    } else if (h == 8 && p == true) {
     ...
     addLine("Your pain contininues to persist as you start to get irritable.")
    } else if (h == 3 && p == true) {
...
if (action == "heatproof glue " + "metal shard" || action == "metal shard " + "heatproof glue") {
    inventory.addItem(metal_shard2);
    inventory.addItem(heat_glue2);
    addLine("You put glue on the shard and got a bottle out of it.")
  } else if (action == "broken ligher " + " glued metal shard" || action == "glued metal shard " + " broken ligher") {
    inventory.addItem(lighter2);
    addLine("You made a functional ligher.")
  } else if (action == "magnum " + "bullet") {
    inventory.addItem(gun1);
    addLine("You loaded the gun.")
  } else if (action == "magnum " + "ammo") {
    inventory.addItem(gun2);
    addLine("You loaded the gun.")
  } else if (action == "SWAT vest " + "padding") {
    inventory.addItem(swat_vest2);
    addLine("You added protection to the vest.")
  } else if (action == "")
